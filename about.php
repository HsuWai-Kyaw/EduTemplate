     ...
     <div id="fh5co-about">
          <div class="container">
               <div class="col-md-6 animate-box">
                    ...
                    <p>Educare International School is an academically focused school that wants to instill and develop
                         strong core values in our students.</p>
                    <p>We firmly believe in the importance and the power of quality education and how it can change
                         lives, societies and countries. </p>
                    <p>As a team, we are committed to educate our next generation and to prepare them to be ready for
                         tomorrow’s world. We aim to deliver quality education to provide more opportunities and access.
                    </p>
               </div>
               <div class="col-md-6">
                    <img class="img-responsive" src="./images/About Us.jpg" alt="AboutUs.jpg">
               </div>
          </div>
     </div>
</div>
